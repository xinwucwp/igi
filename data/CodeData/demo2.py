...
pngDir = None
pngDir = "/home/nlp/research/igi/png/"
def main(args):
  goDemoNotreDame() 
  goDemoTeapot()
...
def goDemoNotreDame():
  ...
  #set tensor=None to construct an isotropic interplator 
  igi = FastImageGuidedInterp(f,x,y,None) 
  igi.setSmoothings(10.0,10.0)
  igi.setIters(100)
  g = igi.grid(sx,sy)
...
def goDemoTeapot():
  ...
  et = makeImageTensors(s)
  #et = lof.applyForTensors(s) # structure tensors
  ch = coherence(3,et,s) # structure-oriented coherence c
  ...
  igi.setTensors(et)
  ch = pow(ch,8)
  fg = igi.grid(st,sx,ch)
  plot2Teapot(f,t,x,s,st,sx,None,"Known value","tp2f")
  plot2Teapot(f,t,x,s,st,sx,fg,"Guided harmonic","tp2q")
